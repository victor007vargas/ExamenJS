...
if (kp2ca==1){gena1();
  nx();imgx=[imebas.slice(0,6),numx,imebas.slice(7,11)] .join("")
  $("#a4").attr("src",imgx)  ;kp2ca=0;  };
...
if (kp4ca==1){gena1();
  ...
  $("#a5").attr("src",imgx);kp3ca=0;
  nx();imgx=[imebas.slice(0,6),numx,imebas.slice(7,11)] .join("")
  $("#a6").attr("src",imgx);kp3ca=0;kp4ca=0;};
...
if (kp5ca==1){gena1();
  ...
  $("#a5").attr("src",imgx);kp3ca=0;
  nx();imgx=[imebas.slice(0,6),numx,imebas.slice(7,11)] .join("")
  $("#a6").attr("src",imgx);kp3ca=0;
  nx();imgx=[imebas.slice(0,6),numx,imebas.slice(7,11)] .join("")
  $("#a7").attr("src",imgx);kp5ca=0;};
